...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field subscribers on 'Comment'
        db.create_table('tcc_comment_subscribers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['tcc.comment'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('tcc_comment_subscribers', ['comment_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field subscribers on 'Comment'
        db.delete_table('tcc_comment_subscribers')
